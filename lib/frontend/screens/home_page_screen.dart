...
import '../../backend/services/recipe_home_api_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> loadUserCaloriesGoal() async {
    try {
      ...
      print('Error loading calorie goals: $e');
    }
  }
  ...
  Future<void> loadCaloriesFromLogs() async {
    ...
    try {
      ...
      print('Error loading calorie logs: $e');
    }
  }
  ...
  Future<void> fetchRecipesForSelectedType() async {
    ...
    try {
      final fetched = await SpoonacularService.fetchRecipes(selectedType);
      setState(() => recipes = fetched);
    } catch (e) {
          ...
          children: [
            ...
            Center(
              child: RecipeTypeSelector(
                ...
                onChanged: (index) {
                  setState(() => selectedRecipeIndex = index);
                  fetchRecipesForSelectedType();
                },
              ),
            ),
